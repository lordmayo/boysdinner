...
urlpatterns = [
    ...
    #url(r'^boysdinner/(?P<user_id>\d+)/mycritics/$', views.my_critics, name='my_critics'),
    #url(r'^boysdinner/(?P<user_id>\d+)/(\d{4}-\d{2}-\d{2})/mycritics/$', views.my_critics, name='my_critics'),
    url(r'^boysdinner/(?P<user_id>\d+)/(?P<raw_served_date>\w+)/mycritics/$', views.my_critics, name='my_critics'),
